...
- [x] Чанкинг записей базы знаний
- [x] Embeddings (Ollama `nomic-embed-text` + offline fallback)
- [x] Индексация в Qdrant
- [x] Семантический поиск в Knowledge Agent
- [x] API search / reindex / rag-status
- [x] Фоновая переиндексация при старте

## Дальше

- обучение на правках пользователя (Memory/Learning);
- более крупные локальные модели (14B/32B);
- финансы, календарь и расширенная корпоративная память;
- импорт PDF/DOCX нормативных документов в knowledge graph.
