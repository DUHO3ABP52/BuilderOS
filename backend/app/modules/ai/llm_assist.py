...
- create_payment — создать платёж/оплату/аванс
- list_payments — список открытых платежей
- finance_summary — баланс/сводка по финансам
- create_event — добавить событие/встречу в календарь
- list_events — ближайшие события календаря
- project_context — граф/контекст строительного объекта и связи
- ask_teacher — спросить облачного учителя (обезличенно) и опционально сохранить паттерн
